...
"[project]/lib/parsers/parseDeliveroo.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "parseDeliverooSheets",
    ()=>parseDeliverooSheets
]);
async function parseDeliverooSheets(files, dateFrom, dateTo) {
    // ── DEBUG ──────────────────────────────────────────────────────────────────
...
// ─── File Parser ─────────────────────────────────────────────────────────────
function parseDeliverooFile(text) {
    const rows = [];
    ...
    for (const line of lines){
        ...
        const deliveryDate = activity === 'Delivery' && deliveryDT ? deliveryDT.substring(0, 10) : '';
        rows.push({
            restaurantName,
            orderNumber,
            deliveryDate,
...
//# sourceMappingURL=lib_parsers_parseDeliveroo_ts_3bb5bada._.js.map